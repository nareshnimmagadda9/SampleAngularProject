...
@Component({
  selector: 'app-bp-canceledorder',
  templateUrl: './bp-canceledorder.component.html',
  styleUrls: ['./bp-canceledorder.component.css']
})
export class BpCanceledorderComponent implements OnInit {
